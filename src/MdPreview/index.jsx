...
function App() {
    ...
    const __html = marked(text || "# Nothing to preview");

    return (
        <div id="MdPreview" className="Grid-2">
            <div className="Column">
                <div dangerouslySetInnerHTML={{ __html }} />
            </div>

            <div className="Column">
                <TextareaX value={text} onChange={(e) => setText(e.target.value)} />
            </div>
        </div>
    );
}
...
const fixture = `# Markdown Quick Reference
